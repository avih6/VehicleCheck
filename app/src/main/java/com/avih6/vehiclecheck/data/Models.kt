...
object VehicleUtils {
    ...
    fun getBrandSlug(hebrewMake: String?): String {
        ...
        val predefined = when {
            ...
            m.contains("אורה") || m.contains("ora") -> "ora"
            m.contains("סקייוול") || m.contains("skywell") -> "skywell"
            m.contains("דונגפנג") || m.contains("dongfeng") -> "dongfeng"
            m.contains("ג'קו") || m.contains("jaecoo") -> "jaecoo"
            m.contains("אומודה") || m.contains("omoda") -> "omoda"
            m.contains("מקסוס") || m.contains("maxus") -> "maxus"
            m.contains("נטה") || m.contains("neta") -> "neta"
